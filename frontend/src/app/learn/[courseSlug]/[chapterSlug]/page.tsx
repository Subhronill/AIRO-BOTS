...
export default function ChapterPage() {
  ...
  const [activeTab, setActiveTab]         = useState<'lesson' | 'code' | 'quiz'>('lesson');
  ...
  const tabs = [
    ...
    ...(chapter.quizzes?.length ? [{ id: 'quiz', label: 'Quiz', Icon: Target }] : []),
  ] as { id: 'lesson' | 'code' | 'quiz'; label: string; Icon: React.ElementType }[];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-20">
        ...
        <div className="flex gap-8 items-start">
          ...
          <main className="flex-1 min-w-0">
            ...
            {/* Tab bar */}
            <div className="border-b border-white/[0.07] mb-7">
              <div className="flex">
